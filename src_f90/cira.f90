...
!    BLOCKDATA GTD7BK
!
! 2011.00 09/27/10 GLOBE7: AP(1),P(1)->AP(7),P(150)
! 2011.00 09/27/10 GLOB7S: P(1)->P(150)
! 2011.00 09/27/10 GTS7: AP(1)->AP(7), PD(150,9)->PDA1(150),..,PDA9(150)
...
! 2014.02 07/24/14 COMMON/iounit/konsol, mess turn off messages
! 2014.05 12/22/14 TSELEC: SV(25),SVV(25)
! 2015.01 02/18/15 switches set (TSELEC) only in main not in GTD7,GLOBE7
! 2015.01 07/20/15 GLOB7S: P(150)->P(100)
!
